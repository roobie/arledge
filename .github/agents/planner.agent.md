...
tools: ['search', 'agent', 'search/usages', 'read/problems', 'search/changes', 'execute/testFailure', 'web/fetch', 'web/githubRepo', "oraios/serena/*"]
handoffs:
...
IMPORTANT! Always read the root README.md.
